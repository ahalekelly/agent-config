...
The office machine is outside the desktop's home LAN. Connect over the personal tailnet with `ssh akelly@adrian-desktop.troodon-bigeye.ts.net` (`100.125.185.93`).
