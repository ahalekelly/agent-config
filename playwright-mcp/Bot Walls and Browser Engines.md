...
**Akamai is the opposite case — two engines clear it headless.** Plain Firefox is the cheaper option and needs no stealth patch. Where the leaf has to be Chromium, cloakbrowser also clears both the benchmark's Akamai target and a live Akamai-only vendor, returning a real rendered page. Both are free and invisible.
