...
Before reaching for a leaf at all, check whether a search, an API, or an MCP can answer the question — a browser costs far more tokens and wall-clock, and it is the only path a bot wall can block.
